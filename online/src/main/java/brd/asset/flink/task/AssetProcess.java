...
public class AssetProcess {
    public static void main(String[] args) throws Exception {
        ...
        DorisSinkBase assetBaseSink = new DorisSinkBase(dorisHost, dorisPort, dorisDB, assetBaseTB, dorisUser, dorisPw, batchSize, batchIntervalMs);

        labeledAssetStream.map(new Entity2JsonMap()).addSink(assetBaseSink.getSink());

        //宽表和asset_base表关联并分流：异常资产&&更新asset_base表
        SingleOutputStreamOperator<Tuple3<String, String, AlarmItem>> abnormalAndLabeledDS = null;
